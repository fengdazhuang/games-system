...
//    ReturnResult queryComNames(@RequestParam Integer competitionCategoryId);
    ...
    ReturnResult addComCategory(@Valid @RequestBody AddCompetitionCategory addCompetitionCategory);

    @PostMapping("/addComInfo")
    @ApiOperation(value = "添加具体运动项目")
    ReturnResult addComInfo(@Valid @RequestBody AddCompetitionInfo addCompetitionInfo);
